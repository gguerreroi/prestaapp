...
router.post('/nuevo', apiAuth, requirePermission('/prestamos', { isApi: true }), createLoan)
router.post('/:id', apiAuth, requirePermission('/prestamos', { isApi: true }), registrarPago)
